...
const dir = path.join(process.cwd(), '.pptx-verify', 'soltam-v7')
...
const html = `<!DOCTYPE html><html lang="he" dir="rtl"><head><meta charset="UTF-8"><title>סולתם v7 — לאחר תיקוני ה-audit</title>
<style>
...
<header><b>סולתם · הסיר שלי, המתכון שלך</b> &nbsp;<span>23 שקפים · נירוסטה + 29 ליקויים תוקנו · לחיצה על תמונה = מסך מלא</span></header>
<main>${cards}</main>
