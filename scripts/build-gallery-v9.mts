...
const dir = path.join(process.cwd(), '.pptx-verify', 'soltam-v9')
...
<header><b>סולתם · הסיר שלי, המתכון שלך</b> &nbsp;<span>23 שקפים · כל 29 הליקויים + 3 המינוריים נסגרו · לחיצה על תמונה = מסך מלא</span></header>
<main>${cards}</main>
