...
const dir = path.join(process.cwd(), '.pptx-verify', 'soltam-v2')
...
const html = `<!DOCTYPE html><html lang="he" dir="rtl"><head><meta charset="UTF-8"><title>סולתם v2 — 22 שקפים (אחרי)</title>
<style>
...
<header><b>סולתם · הסיר שלי, המתכון שלך</b> &nbsp;<span>22 שקפים · המנוע המשודרג · לחיצה על תמונה = מסך מלא</span></header>
<main>${cards}</main>
