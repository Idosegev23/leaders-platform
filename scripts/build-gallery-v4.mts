...
const dir = path.join(process.cwd(), '.pptx-verify', 'soltam-v4')
...
const html = `<!DOCTYPE html><html lang="he" dir="rtl"><head><meta charset="UTF-8"><title>סולתם v4 — סצנות AI קולנועיות</title>
<style>
...
<header><b>סולתם · הסיר שלי, המתכון שלך</b> &nbsp;<span>22 שקפים · סצנות Nano Banana + מוצרים אמיתיים · לחיצה על תמונה = מסך מלא</span></header>
<main>${cards}</main>
