...
const dir = path.join(process.cwd(), '.pptx-verify', 'soltam-v5')
...
const html = `<!DOCTYPE html><html lang="he" dir="rtl"><head><meta charset="UTF-8"><title>סולתם — הדק הסופי</title>
<style>
...
<header><b>סולתם · הסיר שלי, המתכון שלך</b> &nbsp;<span>23 שקפים · סצנות AI קולנועיות על כל שקף נרטיבי · לחיצה על תמונה = מסך מלא</span></header>
<main>${cards}</main>
