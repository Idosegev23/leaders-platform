...
const dir = path.join(process.cwd(), '.pptx-verify', 'soltam-v8')
...
const html = `<!DOCTYPE html><html lang="he" dir="rtl"><head><meta charset="UTF-8"><title>סולתם — הדק הסופי (מלוטש)</title>
<style>
...
<header><b>סולתם · הסיר שלי, המתכון שלך</b> &nbsp;<span>23 שקפים · נירוסטה + אווטארים + 29 ליקויים תוקנו · לחיצה על תמונה = מסך מלא</span></header>
<main>${cards}</main>
