...
const dir = path.join(process.cwd(), '.pptx-verify', 'soltam-visual')
...
const html = `<!DOCTYPE html><html lang="he" dir="rtl"><head><meta charset="UTF-8"><title>סולתם — 19 שקפים</title>
<style>
...
<header><b>סולתם · הסיר שלי, המתכון שלך</b> &nbsp;<span>19 שקפים · הרצת פרוד · לחיצה על תמונה = מסך מלא</span></header>
<main>${cards}</main>
