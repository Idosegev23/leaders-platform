...
2. **חלוקת התמונות:**
   ...
   - **deliverables**: אם יש 1+ productImages — השתמש ב-split-image-text עם תמונה אמיתית של מוצר; אחרת three-pillars-grid.
   ...
   - **caseStudies**: אם יש caseStudy עם hero_image בבלוק <leaders_case_studies> — שקול split-image-text עם התמונה האמיתית.
